...
public abstract class BaseTabPanel extends JPanel {
    ...
    protected final ApplicationService applicationManager;
    protected StatusBar statusBar;

    public BaseTabPanel(MainApplication mainApplication, ApplicationConfig applicationConfig, ApplicationService applicationManager) {
