...
/**
 * Basic toast notification that appears at the bottom-right corner and
 * auto-dismisses
 */
public class ToastNotification extends JWindow {
    ...
    public static void showSuccess(String message) {
        if (!MainApplication.INSTANCE.getApplicationConfig().isToastNotificationsEnabled()) {
            return; // Skip toast in performance mode
        }
