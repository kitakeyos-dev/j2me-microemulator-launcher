 ...
 * Infrastructure implementation of the InputSynchronizer interface.
 */
public class InputSynchronizerImpl implements InputSynchronizer {
    ...
    private void broadcastKeyEvent(KeyEvent sourceEvent) {
        ...
        for (EmulatorInstance targetInstance : instances) {
            ...
            if (targetDevicePanel != null) {
                ...
                Component targetComponent = findCorrespondingComponent(sourceComponent, sourceInstance,
                        targetDevicePanel);
                if (targetComponent != null) {
     ...
     */
    private Component findCorrespondingComponent(Component sourceComponent, EmulatorInstance sourceInstance,
            JPanel targetDevicePanel) {
    ...
    private void dispatchMouseEventToComponent(MouseEvent sourceEvent, Component targetComponent, Point relativePoint,
            JPanel targetDevicePanel) {
        // Convert relative point from devicePanel coordinates to targetComponent
        // coordinates
        try {
