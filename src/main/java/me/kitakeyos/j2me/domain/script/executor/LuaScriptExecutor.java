 ...
 * This is a Domain service - no Infrastructure dependencies.
 */
public class LuaScriptExecutor {
    ...
    public LuaScriptExecutor(Path scriptsDirectory, Consumer<String> outputConsumer,
    ...
    public void executeScript(Path scriptPath) {
        ...
        try {
            ...
            String scriptsDir = scriptsDirectory.toAbsolutePath().toString().replace("\\", "/");
            String currentScriptDir = scriptPath.toAbsolutePath().getParent().toString().replace("\\", "/");
            String packagePath = currentScriptDir + "/?.lua;" + currentScriptDir + "/?/init.lua;" +
                    scriptsDir + "/?.lua;" + scriptsDir + "/?/init.lua";
